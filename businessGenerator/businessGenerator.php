...
<div style="" class="formAtAllDiv">
    ...
    <div id="tabContentBusinessWerteDiv" class="tabContentGeneralClass">
        <!-- Businessnummer -->
    ...
    </div> <!-- END tabContentBusinessWerteDiv -->

    <div id="tabContentAdressenDiv"  class="tabContentGeneralClass" style="display: none">
    ...
    </div> <!-- END tabContentAdressenDiv -->

    <div id="tabContentArtikelDiv" class="tabContentGeneralClass" style="display: none">
